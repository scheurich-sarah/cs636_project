...
if __name__ == "__main__":
    ...
    # create a graph to use with multithread
    #G_mt = cg.create_csr_graph_simple(ifile, num_vcount, ingestion_flag)
    #G_mt.mt = True;
    #print('G.mt = ', G.mt, ' G_mt.mt = ', G_mt.mt)
    print('G.mt = ', G.mt)
    ...
    #net_mt = gcnconv.GCN(G_mt, input_feature_dim, 16, 3)
